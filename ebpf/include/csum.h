...
__attribute__((unused)) static __always_inline __u16 csum_diff4(__u32 from, __u32 to, __u16 oldsum) {
...
__attribute__((unused)) static __always_inline __u16 iph_csum(struct iphdr *iph) {
	iph->check = 0;
