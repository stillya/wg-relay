...
// Parse XDP packet
static __always_inline __maybe_unused int parse_xdp_packet(struct xdp_md *ctx, struct packet_info *pkt) {
...
// Parse TC packet
static __always_inline __maybe_unused int parse_tc_packet(struct __sk_buff *skb, struct packet_info *pkt) {
